<div
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900s dark:text-white dark:text-white">
        Welcome to your Jetstream application!
    </h1>

    <p class="mt-6  text-gray-500s dark:text-white dark:text-white leading-relaxed">
...
<div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900s dark:text-white dark:text-white">
                <a href="https://laravel.com/docs">Documentation</a>
            </h2>
        </div>

        <p class="mt-4  text-gray-500s dark:text-white dark:text-white text-sm leading-relaxed">
